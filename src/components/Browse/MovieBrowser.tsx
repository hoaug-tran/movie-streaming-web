...
const SECTION_CONFIGS = [
  {
    ...
    description: "Những bộ phim hành động kịch tính nhất",
    queryFn: () => movieService.getActionMovies(12),
  },
  {
    id: "trending",
    title: "Đang thịnh hành",
    description: "Phim được xem nhiều nhất tuần này",
    queryFn: () => movieService.getTrendingMovies(12),
  },
  {
    id: "thriller-movies",
    title: "Giật gân hứa hẹn",
    description: "Những bộ phim giật gân đầy kịch tính",
    queryFn: () => movieService.getThrillerMovies(12),
  },
  {
    id: "upcoming",
    title: "Sắp ra mắt",
    description: "Phim mới sắp được phát hành",
    queryFn: () => movieService.getUpcomingMovies(12),
  },
  {
    id: "top-rated",
    title: "Phim đánh giá cao",
    description: "Những bộ phim nhận đánh giá cao nhất",
    queryFn: () => movieService.getTopRatedMovies(12),
  },
  {
    id: "anime-movies",
    title: "Phim anime nổi bật",
    description: "Những bộ phim anime được yêu thích",
    queryFn: () => movieService.getAnimeMovies(12),
  },
  {
    id: "most-commented",
    title: "Bình luận sôi nổi",
    description: "Phim được cộng đồng thảo luận nhiều nhất",
    queryFn: () => movieService.getMostCommented(12),
  },
  {
    id: "top-10-vietnam",
    title: "Top 10 Việt Nam",
    description: "Phim phổ biến nhất tại Việt Nam",
    queryFn: () => movieService.getTopSeriesByRegion("Vietnam", 12),
  },
  {
    id: "korea-movies",
    title: "Phim Hàn Quốc",
    description: "Những bộ phim chất lượng từ Hàn Quốc",
    queryFn: () => movieService.getTopSeriesByRegion("South Korea", 12),
  },
  {
    id: "china-movies",
    title: "Phim Trung Quốc",
    description: "Những bộ phim được yêu thích từ Trung Quốc",
    queryFn: () => movieService.getTopSeriesByRegion("China", 12),
  },
  {
    id: "weekly-new",
    title: "Mới Trên Gió",
    description: "Những bộ phim mới nhất được phát hành tuần này",
...
export default function MovieBrowser({}: MovieBrowserProps) {
  ...
  const { data: categories = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return all.filter((cat: any) => cat.slug === "movie" || !cat.name.includes("Series"));
    },
  });
